...
const T = linux.T;
const VMIN = if (is_mips) 4 else if (is_ppc) 5 else if (native_arch == .alpha) 16 else 6;
const VTIME = if (is_mips) 5 else if (is_ppc) 7 else if (native_arch == .alpha) 17 else 5;
